...
router.post(sub_path + 'rws_programacion_descarga', controllers.programacion_controller.post_descarga_archivos);
...
router.post(sub_path + 'rws_usuario_valida', controllers.usuario_controller.post_validar_usuario);
